...
const Home = () => {
  return (
    <><Header /><div className="flex flex-col items-center justify-center h-screen px-10 text-center py-10 text-white pt-28 bg">
      ...
      <a className="pt-10" href='' download="Dishank's Resume" target='_blank'>
        <button
